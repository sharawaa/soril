  ...
  return (
    <div className="flex justify-center">
      <div className="w-[1170px] h-[410px] flex justify-between  mt-[60px] p-[40px]">
        <div className="flex">
          <div className="bg-white h-[250px] w-[230px] border border-red-200  rounded-2xl p-5 flex flex-col justify-around m-[5px]">
        ...
        <div className="h-[250px] flex flex-col justify-around">
          ...
          <div className="border-y-[1px] h-[73px] border-gray-500">
            <div>사이트가 새롭게 오픈되었습니다. 사이트가 새롭게 오픈..</div>
            <div>2023.07.30</div>
          </div>
